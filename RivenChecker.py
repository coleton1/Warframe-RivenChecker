...
def open_toplevel():
    ...
    if root2 is None or not root2.winfo_exists():
            ...
            news_label = ctk.CTkLabel(root2,text="NEWS COMING SOON",font=("Arial", 14, "bold"))
            news_label.pack()
...
news_button = ctk.CTkButton(root,width=30,height=20,text="Warframe News",command=open_toplevel)
