...
def display_results(weapon, limit, exact_name=None):
    ...
    if sorted_rivens:
        ...
        ##output_text = ctk.Text(root, wrap=ctk.WORD, font=("Courier", 10), height=15, width=60, yscrollcommand=scrollbar.set)
        ...
        scrollbar.configure(command=output_text.yview)  # Configure yscrollcommand
...
# Create a CTkImage instance using the loaded image
...
creator_label.place(relx=0.015,rely=0.95)
